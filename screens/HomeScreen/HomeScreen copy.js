...
// import { View, Text, Button,TouchableOpacity,StyleSheet,Icon } from "react-native";
...
//       <Text style={{ color: "#fff", fontSize: 20 }}>All Songs</Text>
//       {songs.map((song) => (
//         <View key={song.id} style={{ marginVertical: 10 }}>
//           <Text style={{ color: "#fff" }}>{song.title} - {song.author}</Text>
//           <TouchableOpacity onPress={() => playSong(song.url)}>
